...
export class RequestRide {
    ...
    constructor(readonly accountDAO: AccountRepository,  readonly rideDAO: RideRepository){ 

    }

    async execute(input: Input) : Promise<Output> {
        const passenger = await this.accountDAO.getAccountById(input.passengerId);
