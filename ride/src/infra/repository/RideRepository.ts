...
export class RideRepositoryDatabase implements RideRepository {
    ...
    async updateRide(ride: Ride): Promise<void> {
        await this.databaseConnection.query("update db.ride set status = $1, driver_id = $2, last_lat = $3, last_long = $4, distance = $5, fare = $6 where ride_id = $7", [ride.getStatus(), ride.driverId, ride.lastPosition.getLat(), ride.lastPosition.getLong(), ride.distance, ride.fare, ride.rideId], true)
    }
}